...
describe('ExpensesActions', () => {
  let testContext: ActionContext<IExpensesState, IState>;
  ...
  beforeEach(() => {
    testContext = {
      ...
      state: ExpensesDefaultState(),
    } as ActionContext<IExpensesState, IState>;
  ...
  test('it should call INCREMENT action on success', async () => {
    ...
    await ExpensesActions.increment(testContext);
  ...
  test('it should call DECREMENT action on success', async () => {
    ...
    await ExpensesActions.decrement(testContext);
