<template>
  <div :class="$style.vueFooter">
    <vue-grid>
      <vue-grid-row>
        <vue-grid-item>
          <small>&copy; Copyright {{ year }} Dylan Watson</small>
        </vue-grid-item>

        <vue-grid-item>
          <small>
            <a href="https://github.com/lotsabackscatter/expenses-categoriser/blob/master/LICENSE" target="_blank" rel="noopener">
              MIT License
            </a>
          </small>
        </vue-grid-item>
